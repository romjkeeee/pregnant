        ...
        <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-4 text-right">
					<a href="/admin/users/add" class="btn btn-danger" style="margin-top: 30px;">Добавить</a>
                </div>
            </div>
        <div class="wrapper wrapper-content animated fadeInRight ecommerce">
            <div class="row">
				<div class="col-lg-12">
					<form action="/admin/users" class="form form-inline">
						<div class="form-group">
							<input type="text" name="nr" placeholder="Имя, E-mail, Страна..." value="{{ $search }}" class="form-control">
                        ...
                        <div class="ibox-content">
                            <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="15">
                                ...
                                <tr>
									...
									<th data-toggle="true">Компания</th>
									<th data-toggle="true">Страна</th> 
									<th data-toggle="true">E-mail</th>
									<th data-toggle="true">Дата регистрации</th>
									<th data-toggle="true">Последний вход</th>
									...
									@if ($list->count())
										@foreach ($list as $key => $record)
											<tr class="footable-odd">
												...
												<td class="footable-visible">{{ $record->company }}</td>
												<td class="footable-visible">{{ $record->country }}</td>
