            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-8">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="{{ route('admin_patient') }}">Клиники</a>
                        </li>
                        <li class="active">
                ...
                <div class="col-lg-4 text-right">
					<a href="{{ route('admin_patient_add') }}" class="btn btn-danger" style="margin-top: 30px;">Добавить</a>
                </div>
            </div>
        <div class="wrapper wrapper-content animated fadeInRight ecommerce">
            <div class="row">
				<div class="col-lg-12">
					<form action="{{ route('admin_patient') }}" class="form form-inline">
						<div class="form-group">
							<input type="text" name="query" placeholder="ФИО, Телефон..." value="{{ $search }}" class="form-control">
									...
									@if ($list->count())
										@foreach ($list as $key => $record)
											<tr class="footable-odd">
												...
												<td class="footable-visible">{!! $record->clinic !!}</td>
