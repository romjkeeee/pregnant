        ...
        <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-4 text-right">
					<a href="{{ route('admin_ucadd') }}" class="btn btn-danger" style="margin-top: 30px;">Добавить</a>
                </div>
            </div>
        <div class="wrapper wrapper-content animated fadeInRight ecommerce">
            <div class="row">
				<div class="col-lg-12">
					<form action="{{ route('admin_users_parents') }}" class="form form-inline">
                        ...
                        <div class="ibox-content">
                            <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="15">
                                ...
                                <tr>
									...
									<th data-toggle="true">Родитель</th>
									...
									@if ($list->count())
										@foreach ($list as $key => $record)
											<tr class="footable-odd">
												...
												<td class="footable-visible">{!! $record->parent !!}</td>
												<td class="footable-visible">{{ date('d.m.Y - H:i', strtotime($record->created_at)) }}</td>
												<td class="text-right footable-visible footable-last-column">
													<div class="btn-group">
														<a href="/admin/users/childs/edit/{{ $record->id }}" class="btn-white btn btn-xs"><i class="fa fa-pencil"></i></a>
