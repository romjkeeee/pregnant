...
@section('content')
        ...
        <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
					...
					@else
						<h2>Редактировать арендатора</h2> 
					@endif
                    <ol class="breadcrumb">
                        <li>
                        ...
                        <li class="active">
							...
							@else
								<strong>Редактировать арендатора</strong>
							@endif
                        </li>
                    </ol>
                </div>
        ...
        <div class="wrapper wrapper-content animated fadeInRight ecommerce">
			@if (!isset($id))
				<form action="{{ route('admin_arenusadd') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
			@else
				<form action="{{ route('admin_arenusedit', $id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
			@endif		
			@csrf
			<div class="row">
				<div class="col-lg-12">
