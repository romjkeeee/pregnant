            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-8">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Список объявлений</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-4 text-right">
					<a href="/admin/ads/add" class="btn btn-danger" style="margin-top: 30px;">Добавить</a>
                </div>
            </div>
        <div class="wrapper wrapper-content animated fadeInRight ecommerce">
            <div class="row">
				<div class="col-lg-12">
					<form action="/admin/ads" class="form form-inline">
						<div class="form-group">
							<input type="text" name="nr" placeholder="Заголовок, Текст..." value="{{ $search }}" class="form-control">
                        ...
                        <div class="ibox-content">
                            <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="15">
                                ...
                                <tr>
									...
									<th data-toggle="true">Разместил</th>
									<th data-toggle="true">Заголовок</th>
									<th data-toggle="true">Оплачено</th> 
									...
									@if ($list->count())
										@foreach ($list as $key => $record)
											<tr class="footable-odd">
												...
												<td class="footable-visible">{{ $record->author }}</td>
												...
												<td class="text-right footable-visible footable-last-column">
													<div class="btn-group">
														<a href="/admin/ads/edit/{{ $record->id }}" class="btn-white btn btn-xs"><i class="fa fa-pencil"></i></a>
														<a href="/admin/delete_record/ads/{{ $record->id }}" class="btn-white btn btn-xs"><i class="fa fa-close"></i></a>
													</div>
												</td>
											</tr>
										@endforeach
