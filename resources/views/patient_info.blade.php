...
@section('content')
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                <h2>Пациент {{ $rec->last_name }} {{ $rec->name }} {{ $rec->second_name }}</h2>
                @if (session('error'))
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <strong>Пациент {{ $rec->last_name }} {{ $rec->name }} {{ $rec->second_name }}</strong>
                    </li>
                </ol>
            </div>
        ...
        <div class="wrapper wrapper-content animated fadeInRight ecommerce">
            <form action="" method="GET">
                <div class="row">
                            ...
                            <div class="ibox-content">
                                <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="15">
                                    ...
                                    <tr>
                                        <td>Дата рождения</td>
                                        <td>
											{{ date('d.m.Y', strtotime($rec->date_of_birth)) }}
                                        </td>
                                    </tr>
                                </table>
                            </div>
                    ...
                    <div class="col-lg-12">
						<a href="{{ route('admin_patient_add') }}" class="btn btn-success">Добавить пациента</a>
                        <a href="{{ route('admin_patient_edit', $rec->id) }}" class="btn btn-primary">Обновить пациента</a>
                        <a href="/admin/delete_record/patient/{{ $rec->id }}" class="btn btn-danger">Удалить</a>
                        <br/><br/>
                    </div>
					<div class="col-lg-12">
						<div class="ibox">
