...
@section('breadcrumbs', Breadcrumbs::render('admin.doctors.schedules.edit', $instance->id))
@section('form-action', route('admin.doctors.schedules.update', $instance->id))
@section('header-btn')
    <a href="{{ route('admin.doctors.schedules.index') }}" class="btn btn-danger" style="margin-top: 30px;">К списку графиков</a>
@endsection
@section('fields')
    @method('PUT')
    <div class="row">
