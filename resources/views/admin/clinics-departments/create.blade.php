...
@section('breadcrumbs', Breadcrumbs::render('admin.clinic-departments.create'))
@section('form-action', route('admin.clinic-departments.store'))
@section('header-btn')
    <a href="{{ route('admin.clinic-departments.index') }}" class="btn btn-danger" style="margin-top: 30px;">К списку департаментов</a>
@endsection
@section('fields')
    @method('POST')
    <div class="row">
