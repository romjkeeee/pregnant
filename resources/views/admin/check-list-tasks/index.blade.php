...
@section('breadcrumbs', Breadcrumbs::render('admin.check-list-tasks.index'))
@section('header-btn')
    <div style="display: flex; justify-content: flex-end; align-items: center">
        ...
        @endif
        <a href="{{ route('admin.check-list-tasks.create') }}" class="btn btn-danger" style="margin-top: 30px; margin-left: 10px;">Добавить</a>
    </div>
@endsection
    ...
    @foreach ($items as $item)
        <tr class="footable-odd">
            ...
            <td class="text-right footable-visible footable-last-column">
                @include('components.action', ['edit' => route('admin.check-list-tasks.edit', $item->id)])
            </td>
        </tr>
    @endforeach
@endsection
