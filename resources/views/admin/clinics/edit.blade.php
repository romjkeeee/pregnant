    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            @include('components.ajax-select', ['name' => 'region_id','title' => 'Регион<span class="req">*</span>',
                     'route' => 'admin.preload.regions', 'default' => ['val' => $instance->region_id, 'text' => $instance->region->name ?? null]])
        </div>
        <div class="col-lg-6">
            @include('components.ajax-select', ['name' => 'city_id','title' => 'Город<span class="req">*</span>',
                     'route' => 'admin.preload.cities', 'default' => ['val' => $instance->city_id, 'text' => $instance->city->name ?? null]])
        </div>
        <div class="col-lg-4">
            <div class="form-group" style="padding: 5px">
                <strong style="margin-bottom: 10px!important;">Адрес <span class="req">*</span></strong>
                <input type="text" name="address" value="{{ old('address', $instance->address) }}" class="form-control">
            </div>
        </div>
        <div class="col-lg-4">
            <div class="form-group" style="padding: 5px">
