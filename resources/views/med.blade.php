...
@section('content')
        ...
        <div class="wrapper wrapper-content animated fadeInRight ecommerce">
            <div class="row">
				<div class="col-lg-6">
    				<form action="{{ route('admin_med') }}" class="form form-inline">
    					<div class="form-group">
							<input type="text" name="query" value="{{ $search }}" placeholder="ФИО, Телефон..." class="form-control">
                        ...
                        <div class="ibox-content">
                            <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="15">
                                ...
                                <tr>
									...
									<th data-toggle="true">Клиники</th>
									...
									@if ($list->count())
										@foreach ($list as $record)
											<tr class="footable-odd">
												...
												<td class="footable-visible">{!! $record->clin !!}</td>																			
