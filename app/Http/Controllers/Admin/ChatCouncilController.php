...
class ChatCouncilController extends Controller
{
    /**
    ...
    {
        return view('admin.chat-council.index', [
            'page_title' => 'Спичок консилиумов',
            'search' => $request->get('search'),
            'items' => Chat::query()->where('group_type', UsersGroup::COUNCIL)->when($request->get('search'), function (Builder $chat) use ($request) {
    ...
    {
        return view('admin.chat-council.create', ['page_title' => 'Добавление консилиума']);
    }
    ...
    public function store(StartGroupRequest $request)
    {
        ...
        return redirect()->route('admin.chat-council.index')->with('success', 'Консилиум успешно добавлен!');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.chat-council.edit', [
            'page_title' => 'Редактирование консилиума',
            'chat' => $chat
        ]);
    }
